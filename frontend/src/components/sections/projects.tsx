                        ...
                        projects.map((project, index) => (
                            ...
                            >
                                <div className="glass-morphism h-full flex flex-col overflow-hidden hover:border-blue-500/40 hover:shadow-[0_0_40px_rgba(56,189,248,0.1)] transition-all duration-500">
                                    {/* Image Area */}
                                    <div className="relative h-56 w-full bg-[#0a0c10] overflow-hidden">
                                        ...
                                        <div className="absolute top-4 right-4 flex gap-2 overflow-hidden items-center translate-y-[-100%] group-hover:translate-y-0 transition-transform duration-300">
                                            <Link href={project.githubUrl || "#"} className="p-2 rounded-full bg-black/50 backdrop-blur-md border border-white/10 text-white hover:bg-primary transition-colors">
                                                <Github className="w-4 h-4" />
                                            </Link>
                                            <Link href={project.demoUrl || "#"} className="p-2 rounded-full bg-black/50 backdrop-blur-md border border-white/10 text-white hover:bg-primary transition-colors">
